...
export const canisterId = process.env.EXPENSORY_IC_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./expensory_ic_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the expensory_ic_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./expensory_ic_backend.did.js")._SERVICE>}
 */
export const expensory_ic_backend = createActor(canisterId);
